    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex-grow">
          <h3 className="text-xl font-semibold mb-4">{t("Tautan Cepat", "Quick Links")}</h3>
        ...
        <div className="flex-shrink-0 w-full md:w-1/3">
          <h3 className="text-xl font-semibold mb-4">{t("Informasi Kontak", "Contact Information")}</h3>
